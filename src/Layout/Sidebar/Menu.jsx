export const MENUITEMS = [
    ...
    Items: [
      {
        ...
        active: false,
        children: [
          { path: `${process.env.PUBLIC_URL}/dashboard`, title: "Home", type: "link" },
          { path: `${process.env.PUBLIC_URL}/dashboard/users`, title: "User Management", type: "link" },
...

      {
        ...
        active: false,
        children: [
          // { path: `${process.env.PUBLIC_URL}/dashboard/peminjaman/`, title: "Borrowing", type: "link" },
          { path: `${process.env.PUBLIC_URL}/dashboard/peminjaman/request/`, title: "Request", type: "link" },
          { path: `${process.env.PUBLIC_URL}/dashboard/peminjaman/approve/`, title: "Approve", type: "link" },
          { path: `${process.env.PUBLIC_URL}/dashboard/peminjaman/borrowed/`, title: "Borrowed", type: "link" },
          { path: `${process.env.PUBLIC_URL}/dashboard/peminjaman/return/`, title: "Return", type: "link" },
          { path: `${process.env.PUBLIC_URL}/dashboard/peminjaman/done/`, title: "Done", type: "link" },
          { path: `${process.env.PUBLIC_URL}/dashboard/peminjaman/reject/`, title: "Reject", type: "link" },
        ],
      },
    ],
  },

  {
    ...
    Items: [
      ...
      //   ],
      // },
      { path: `${process.env.PUBLIC_URL}/dashboard/buku`, icon: "file", title: "Buku", type: "link" },
      // { path: `${process.env.PUBLIC_URL}/app/file-manager`, icon: "file", title: "Genre", type: "link" },
      // { path: `${process.env.PUBLIC_URL}/app/file-manager`, icon: "file", title: "Role", type: "link" },
      // {
      //   title: "Ecommerce",
      //   icon: "ecommerce",
      //   type: "sub",
