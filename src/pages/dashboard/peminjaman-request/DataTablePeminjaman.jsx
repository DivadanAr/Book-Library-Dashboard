...
const DataTablePeminjaman = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get('http://127.0.0.1:9000/api/peminjaman/get/request');
            ...
            const newDataTable = dataUser.map((data, index) => ({
                ...
                action: (
                    <Row>
                    <Btn attrBtn={{ color: "primary", className: "d-block w-10 mt-2", onClick: (e) => handleAction(data.id) }}>Approve</Btn>
                    <Btn attrBtn={{ color: "danger", className: "d-block w-10 mt-2", onClick: (e) => handleReject(data.id) }}>Reject</Btn>
    ...
    const handleReject = async (id) => {
        const data = {
          status_peminjaman: "reject",
        };
      
        try {
          const response = await axios.put("http://127.0.0.1:9000/api/peminjaman/change-status/"+id, data, {
            headers: {
