...
const DataTablePeminjaman = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get('http://127.0.0.1:9000/api/peminjaman/get/borrowed');
...
console.log(dataUser);
            ...
            const newDataTable = dataUser.map((data, index) => ({
                ...
                action: (
                    <Btn attrBtn={{ color: "primary", className: "d-block w-10 mt-2", onClick: (e) => handleAction(data.id) }}>Return</Btn>
